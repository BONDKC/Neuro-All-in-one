...
window.ATTENDING_SCHEDULE = {
  ...
  // One or more resident names per day. Some days are a single
  // "day" shift, most split into am/pm with possibly different
  // people (and sometimes several people at once).
  emu: [
    { date: "2026-08-03", day: ["Harrison"] },
    { date: "2026-08-04", am: ["Abraham", "Stojiljkovic"], pm: ["Abraham", "Voelker-Dunbar"] },
    { date: "2026-08-05", am: ["Loiola", "Harrison"], pm: ["Loiola"] },
    { date: "2026-08-06", am: ["Hey"] },
    { date: "2026-08-07", am: ["Harrison"] },
    { date: "2026-08-10", am: ["Bonda", "Horn Barbosa", "Amrit"], pm: ["Gopalkrishnan", "Magadia", "Amrit"] },
    { date: "2026-08-11", am: ["Gopalkrishnan", "Rutledge", "Harrison"], pm: ["Gopalkrishnan", "Curl"] },
    { date: "2026-08-12", am: ["Curl", "Voelker-Dunbar", "Bonda", "Gopalkrishnan"], pm: ["Voelker-Dunbar"] },
    { date: "2026-08-13", day: ["Magadia"] },
    { date: "2026-08-14", am: ["Voelker-Dunbar"] },
    { date: "2026-08-17", am: ["Amrit", "Horn Barbosa", "Rutledge"], pm: ["Horn Barbosa", "Amrit", "Schweitzer", "Rutledge"] },
    { date: "2026-08-18", am: ["Loiola", "Amrit", "Harrison", "Schweitzer"], pm: ["Amrit", "Harrison", "Schweitzer", "Goel"] },
    { date: "2026-08-19", am: ["Loiola", "Harrison", "Rutledge"], pm: ["Schweitzer", "Harrison"] },
    { date: "2026-08-20", am: ["Gopalkrishnan"] },
    { date: "2026-08-21", am: ["Goel", "Rutledge"] },
    { date: "2026-08-24", am: ["Avdeeva", "Abraham"], pm: ["Abraham", "Magadia"] },
    { date: "2026-08-25", am: ["Amrit", "Goel"], pm: ["Amrit", "Goel", "Schweitzer"] },
    { date: "2026-08-26", am: ["Amrit", "Schweitzer", "Cole Wyatt (MS4)"], pm: ["Schweitzer"] },
    { date: "2026-08-27", am: ["Kolsrud", "Mian"] },
    { date: "2026-08-28", am: ["Goel", "Schweitzer", "Magadia"] }
  ]
};
